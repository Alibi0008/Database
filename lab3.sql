...
-- Task 2: Assuming lab3.sql has been executed and tables have been created
...
-- Task 10: Select the number of employees in each department (show department code and number of employees)
...
-- Task 12: Select the name of the department with the second highest budget
SELECT name FROM departments ORDER BY budget DESC LIMIT 1 OFFSET 1;

-- Task 13: Select the name and last name of employees working for departments with the lowest budget
...
-- Task 15: Select all departments with a budget more than 60000, sorted by increasing budget and decreasing code
SELECT * FROM departments WHERE budget > 60000 ORDER BY budget ASC, code DESC;

-- Task 16: Reduce the budget of department with the lowest budget by 10%
